...
Public Class ClsKoneksi
    ...
    Public Function OpenConn() As Boolean
        Cn = New OleDb.OleDbConnection(
            "Provider=SQLOLEDB.1; Integrated Security=SSPI; Persist Security Info=False; User ID=admin; Password=admin; Initial Catalog=dbPenjualan; Data Source=LAPTOP-7TKO491S\SQLEXPRESS")
        Cn.Open()
