...
Public Class LprSupplier
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AplikasiPenjualan.LprSupplier.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLprSupplier
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LprSupplier = New LprSupplier()
        rpt.Site = Me.Site
        Return rpt
    End Function
