...
Public Class LprPelanggan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AplikasiPenjualan.LprPelanggan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLprPelanggan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LprPelanggan = New LprPelanggan()
        rpt.Site = Me.Site
        Return rpt
    End Function
